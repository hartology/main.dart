...
import 'package:run_tracker/authprovider/auth_provider.dart';
import 'package:run_tracker/ui/login/login_screen.dart';
          ...
          return MaterialApp(
              ...
              darkTheme: ThemeData(
                colorScheme: ColorScheme.fromSwatch().copyWith(
                    secondary: Colur.white, brightness: Brightness.light),
              ...
              routes: <String, WidgetBuilder>{
                ...
                '/homeWizardScreen': (BuildContext context) =>
                    HomeWizardScreen(),
                '/uselocationScreen': (BuildContext context) =>
                    UseLocationScreen(),
